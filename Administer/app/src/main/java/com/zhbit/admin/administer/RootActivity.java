...
import static com.zhbit.admin.administer.Constant.DATE_INPUT_DIALOG_ID;
import static com.zhbit.admin.administer.Constant.DOWN_TIME;
import static com.zhbit.admin.administer.Constant.MAIN_GROUP;
import static com.zhbit.admin.administer.Constant.MENU_GENDER_ABOUT;
import static com.zhbit.admin.administer.Constant.MENU_GENDER_HELP;
import static com.zhbit.admin.administer.Constant.UP_TIME;
import static com.zhbit.admin.administer.Constant.YEAR_INTERVAL;
import static com.zhbit.admin.administer.Constant.borrowbook;
...
public class RootActivity extends AppCompatActivity {
        ...
        gvlose.setOnItemClickListener(
                new OnItemClickListener()
                {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                        ...
                        loseInfo1=new DBUtil().getBNSomeInfo(booknum);
                        gotolosedetailsView();
                    }
                }
        );
        ...
        bt.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        int num=new DBUtil().getMaxGSBH()+1;
        ...
        rt.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        int flag=new DBUtil().checktime(SnameID, bookno);
        ...
        select.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        temp7=new DBUtil().selectbookinformationfrombookno(yuyuetemp);
        ...
        borrow.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println(yuyuetemp);
                        String orderStuNO=new DBUtil().getstu(yuyuetemp);



                        int a=new DBUtil().selectcount(StuNO);
                        if(StuNO.equals(""))
                        {
                            Toast.makeText
                                    (
                        ...
                        {
                            System.out.println(temp7[1]);
                            System.out.println("FF1115555");
                            new DBUtil().borrowbook(yuyuetemp,StuNO);
                            Toast.makeText
                                    (
                                            RootActivity.this,
                                            "借阅成功",
                ...
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        if(temp7[5].equals("否"))
                        {
                            ...
                            new DBUtil().orderbook(yuyuetemp,StuNO);
                            System.out.println("test13334444");
                            Toast.makeText
                                    (
                                            RootActivity.this,
                                            "预约成功",
        ...
        select.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        tempp=Stuno;
                        temp3=new DBUtil().selectStu(tempp);
                        gotostuselectView();
                    }
        ...
        bok.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View arg0) {
                        // TODO Auto-generated method stub
                        new DBUtil().addStu(temp2[0],temp2[1],temp2[4],temp2[2],temp2[6],temp2[7],temp2[5],temp2[3],temp2[8]);
                        Toast.makeText
                                (
                                        RootActivity.this,
                                        "添加学生成功",
        ...
        bok.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        EditText stuXueyuanEdit=(EditText)findViewById(R.id.modify_studentmanagementxueyuanedit);
                        EditText stuPwdEdit=(EditText)findViewById(R.id.modify_studentmanagementpasswordedit);
                        temp3[0]=stuNameEdit.getText().toString();
                        temp3[2]=stuSexEdit.getText().toString();
                        temp3[6]= stuQuanxianEdit.getText().toString();
                        temp3[1]=stuAgeEdit.getText().toString();
                        temp3[5]=stuTelEdit.getText().toString();
                        temp3[3]=    stuClassEdit.getText().toString();
                        temp3[4]=    stuXueyuanEdit.getText().toString();
                        temp3[7] =  stuPwdEdit.getText().toString();

                        new DBUtil().updateStu(tempp, temp3[0], temp3[1], temp3[2], temp3[3],temp3[4], temp3[5], temp3[6], temp3[7]);
                        Toast.makeText
                                (
                                        RootActivity.this,
                                        "修改成功",
        ...
        select.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        tempp1=mgNo;
                        temp4=new DBUtil().SelectAdmin(mgNo);
        ...
        addbok.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View arg0) {
                        ...
                        {
                            if(new DBUtil().insertManager(mgNo, mgpermitted, mgpwd))
                            {
                                Toast.makeText
                                        (
                                                RootActivity.this,
    ...
    public void gotoandminselectView()
    {
        ...
        pwd.setText(new DBUtil().selectAdminPassword(tempp1));
                ...
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        else
                        {
                            ...
                            String oldpassword2=new DBUtil().selectAdminPassword(tempp1);
                            if(oldpassword2.equals(oldpassword1))
                            {
                                EditText adminnewpwd21=(EditText)findViewById(R.id.adminnewpwd2edit_mofidy);

                                new DBUtil().updateManager(tempp1,adminnewpwd21.getText().toString());
                                Toast.makeText
                                        (
                                                RootActivity.this,
                                                "修改密码成功",
        ...
        selectfee.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            feetodetailed=new DBUtil().selectfeeinformation(feeStuNO);
        ...
        dlu.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        String ppwd=d1.selectADPwd(sname);

                        if(spwd.equals(ppwd))
                        {
                            permitted=new DBUtil().CheckPermitted(sname);
                            goToMainMenu();
        ...
        bselectbook.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            temp1=isbn;
                            selectTOgird=new DBUtil().selectbookfromISBN(isbn);
        ...
        bok.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        temp[8]=new DBUtil().getBookNumber();
        ...
        bok.setOnClickListener(
                ...
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        temp1=isbn.getText().toString();
                        selectTOgird.set(3,buytime.getText().toString());
                        selectTOgird.set(0,bookname.getText().toString());
                        selectTOgird.set(1, bookauthor.getText().toString());
                        //selectTOgird.set(1,press.getText().toString());
                        selectTOgird.set(2,press.getText().toString());
                        selectTOgird.set(7,instroduction.getText().toString());


                        System.out.println("TEST");
                        //new DBUtil().updateBook(temp5[0],selectTOgird.get(0).toString(),selectTOgird.get(1).toString(),selectTOgird.get(2).toString(),buytime.gett.toString(),temp5[1],temp5[2],s1);

                        System.out.println(temp5[0]);
                        //System.out.println("TEST1");
                        System.out.println(selectTOgird.get(0).toString());
                        //System.out.println("TEST2");
                        System.out.println(selectTOgird.get(1).toString());
                        //System.out.println("TEST3");
                        System.out.println(selectTOgird.get(2).toString());
                        //System.out.println("TEST4");
                        System.out.println(selectTOgird.get(3).toString());
                        //System.out.println("TEST5");
                        System.out.println(temp5[1]);
                        System.out.println(temp5[2]);
                        System.out.println(selectTOgird.get(7).toString());

                        //System.out.println("TEST111");

                        new DBUtil().updateBook(temp5[0],selectTOgird.get(0).toString(),selectTOgird.get(1).toString(),selectTOgird.get(2).toString(),selectTOgird.get(3).toString(),temp5[1],temp5[2],selectTOgird.get(7).toString());
        ...
        bok.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View arg0) {
                        ...
                        System.out.println("OKOKOK111");

                        new DBUtil().insertBook(temp[0],temp[8],temp[3],temp[1],temp[4],temp[2],temp[5],temp[6],temp[7]);
                        Toast.makeText
                                (
                                        RootActivity.this,
                                        "图书入库成功",
...
//    	    		hmap.put("col8", v.get(i*8+7));//第八列为介绍
                    ...
                    public void onClick(View v) {
                        ...
                        if(simpleq.isChecked())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    queryTOgird=new DBUtil().selectAllfrombook(result);
                                    toast(queryTOgird,resultnumdetails);
                                }
                                else if(id.equals("2"))//通过作者进行查询
                                {
                                    queryTOgird=new DBUtil().getAuthorAllfromBook(result);
                                    toast(queryTOgird,resultnumdetails);
                                }
                                else if(id.equals("3"))//通过出版社进行查询
                                {
                                    queryTOgird=new DBUtil().getPubAllfrombook(result);
                                    toast(queryTOgird,resultnumdetails);
                                }
                            }
                        }
                        else if(highq.isChecked())
                        {
                            ...
                            {
                                queryTOgird=new DBUtil().getBnAuAllfrombook(highSM, highZZ);
                                toast(queryTOgird,resultnumdetails);
                            }
                            //书名和出版社的组合查询
                            else if((!highSM.equals(""))&&(highZZ.equals(""))&&(!highCBS.equals("")))
                            {
                                queryTOgird=new DBUtil().getBnCbAllfrombook(highSM, highCBS);
                                toast(queryTOgird,resultnumdetails);
                            }
                            //作者和出版社的组合查询
                            else if((highSM.equals(""))&&(!highZZ.equals(""))&&(!highCBS.equals("")))
                            {
                                queryTOgird=new DBUtil().getAuCbAllfrombook(highZZ, highCBS);
                                toast(queryTOgird,resultnumdetails);
                            }
                            //书名作者出版社三者的组合查询
                            else if((!highSM.equals(""))&&(!highZZ.equals(""))&&(!highCBS.equals("")))
                            {
                                queryTOgird=new DBUtil().getBnAuCbAllfrombook(highSM, highZZ, highCBS);
                                toast(queryTOgird,resultnumdetails);
                            }
                            else
                            {
    ...
    public void toast(Vector<String> v,Vector<Integer> vv)
    {
        ...
        else
        {
            ...
            {
                vv.add(new DBUtil().getNumfrombdetailedInfo(v.get(i*4).toString().trim()));
            }
            gotogirdView();
        }
