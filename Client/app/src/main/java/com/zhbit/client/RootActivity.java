                ...
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        else
                        {
                            yuyuedetails1.clear();
                            yuyuedetails2.clear();
                            yuyuedetails1=new DBUtil().getISinfromdetails(bookno);
                            ...
                            {
                                System.out.println(yuyuedetails1.get(0).toString());
                                yuyuedetails2=new DBUtil().getISfrombook(yuyuedetails1.get(0).toString().trim());
                                gotoyuyuedetails();
                            }
                        }
                    }
        ...
        managebook.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        yuyueManage1=new DBUtil().getBNofromOrder(sname);
    ...
    public void gotoQueryMainView()
    {
        ...
        selfb1.setOnClickListener(
                new OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        selfQuery=new DBUtil().getSomeInfo(sname);
                        gotoSelfView();
                    }
